  ...
  <div class="table">
    ...
    <ul class="table-body">
      <!-- <li v-for="(item, index) in data" :key="index" class="table-province" @click="expandLine(item.pinyin)"> -->
        <li v-for="(item, index) in data" :key="index" class="table-province" @click="pinyin=item.pinyin"> 
        ...
        <ul :id='item.pinyin' :class="['table-expand', pinyin == item.pinyin?'table-expand-show':'table-expand-hidden']">
