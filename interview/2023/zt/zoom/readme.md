- 我是谁+从哪里来+我做过什么+有什么成绩+为什么能胜任
    面试官你好，我叫蔡蔡，现就读东华理工大学19级软件工程专业。从一开始看语言精粹，你不知道的Javascript 入门前端学习， 到写小程序， 用vue3仿懂车帝，期间一路踩坑， 一路学习， es6 的优雅和typescript 的强大， 在项目差不多出来时， 让自己很有成就感。 平时也在掘金看文章， 写文章， 刷leetcode, 期待能来贵公司前端岗实习。 
- http 无状态
