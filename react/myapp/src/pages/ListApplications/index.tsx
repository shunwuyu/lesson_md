...
type ListApplicationsProps = {
  dispatch: Dispatch;
  listApplications: StateType;
  loading: boolean;
};
...
export const ListApplications: FC<ListApplicationsProps> = (props) => {
  const {
    dispatch,
    loading,
...
export default connect(
  ({
    ...
    listApplications,
    loading: loading.models.listApplications,
  }),
)(ListApplications);
